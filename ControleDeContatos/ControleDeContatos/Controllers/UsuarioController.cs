    ...
    public class UsuarioController : Controller
    {
        ...
        public IActionResult Apagar(int id)
        {
            try
            {
                ...
                if (apagado)
                {
                    TempData["MensagemSucesso"] = "Uusario apagado com sucesso!";
                }
                else
                {
            ...
            {
                TempData["MensagemSucesso"] = $"Ops, não conseguimos apagar seu usuario, mais detalhes do erro: {erro.Message}";
                return RedirectToAction("Index");
            }
        }
